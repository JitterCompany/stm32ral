...
pub use crate::stm32l4::peripherals::tim16_v2::Instance;
pub use crate::stm32l4::peripherals::tim16_v2::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::tim16_v2::{
