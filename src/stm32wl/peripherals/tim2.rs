...
pub mod OR1 {
    ...
    pub mod TI4_RMP {
        ...
        pub mod RW {
            ...
            /// 0b00: TIM2 TI4 is connected to GPIO: Refer to Alternate Function mapping
            pub const GPIO: u32 = 0b00;

            /// 0b01: TIM2 TI4 is connected to COMP1_OUT
            pub const COMP_1: u32 = 0b01;

            /// 0b10: TIM2 TI4 is connected to COMP2_OUT
            pub const COMP_2: u32 = 0b10;

            /// 0b11: TIM2 TI4 is connected to a logical OR between COMP1_OUT and COMP2_OUT
            pub const COMP_12: u32 = 0b11;
        }
    }
    ...
    pub mod ETR_RMP {
        ...
        pub mod RW {
            ...
            /// 0b0: TIM2 ETR is connected to GPIO: Refer to Alternate Function mapping
            pub const GPIO: u32 = 0b0;

            /// 0b1: LSE internal clock is connected to TIM2_ETR input
            pub const TIM2_ETR: u32 = 0b1;
        }
    }
}
