...
pub use crate::stm32h5::peripherals::spi::Instance;
pub use crate::stm32h5::peripherals::spi::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::spi::{
    CFG1, CFG2, CR1, CR2, CRCPOLY, I2SCFGR, IER, IFCR, RXCRC, RXDR, SR, TXCRC, TXDR, UDRDR,
};
...
/// Access functions for the SEC_SPI4 peripheral instance
pub mod SEC_SPI4 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_SPI4
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CFG1: 0x00070007,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_SPI4_TAKEN: bool = false;

    /// Safe access to SEC_SPI4
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to SEC_SPI4
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_SPI4_TAKEN && inst.addr == INSTANCE.addr {
                SEC_SPI4_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_SPI4: *const RegisterBlock = 0x50014c00 as *const _;

/// Access functions for the SEC_SPI5 peripheral instance
pub mod SEC_SPI5 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_SPI5
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CFG1: 0x00070007,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_SPI5_TAKEN: bool = false;

    /// Safe access to SEC_SPI5
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to SEC_SPI5
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_SPI5_TAKEN && inst.addr == INSTANCE.addr {
                SEC_SPI5_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_SPI5: *const RegisterBlock = 0x54002000 as *const _;

/// Access functions for the SEC_SPI6 peripheral instance
pub mod SEC_SPI6 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_SPI6
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CFG1: 0x00070007,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_SPI6_TAKEN: bool = false;

    /// Safe access to SEC_SPI6
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to SEC_SPI6
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_SPI6_TAKEN && inst.addr == INSTANCE.addr {
                SEC_SPI6_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_SPI6: *const RegisterBlock = 0x50015000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SPI4: *const RegisterBlock = 0x40014c00 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SPI5: *const RegisterBlock = 0x44002000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SPI6: *const RegisterBlock = 0x40015000 as *const _;
