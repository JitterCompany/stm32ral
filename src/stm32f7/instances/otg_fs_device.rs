...
pub use crate::stm32f7::peripherals::otg_fs_device::Instance;
pub use crate::stm32f7::peripherals::otg_fs_device::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::otg_fs_device::{
