...
pub mod CCR {
    ...
    pub mod DMACFG {
        ...
        pub mod RW {
            ...
            pub const OneShotMode: u32 = 0b0;

            /// 0b1: DMA Circular mode selected
            pub const CircularMode: u32 = 0b1;
        }
    }
    ...
    pub mod MDMA {
        ...
        pub mod RW {
            ...
            /// 0b01: Enable dual interleaved mode to output to the master channel of DFSDM interface both Master and the Slave result (16-bit data width)
...
pub const ADC_Common: *const RegisterBlock = 0x50040300 as *const _;
