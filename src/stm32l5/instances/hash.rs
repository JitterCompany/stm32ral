...
pub use crate::stm32l5::peripherals::hash::Instance;
pub use crate::stm32l5::peripherals::hash::{RegisterBlock, ResetValues};
pub use crate::stm32l5::peripherals::hash::{
    ...
    CSR9, DIN, HR0, HR1, HR2, HR3, HR4, HR5, HR6, HR7, HRA0, HRA1, HRA2, HRA3, HRA4, IMR, SR, STR,
};
