...
pub mod EGR {
    ...
    pub mod CC1G {
        ...
        pub mod W {
            ...
            /// 0b1: If CCx is an output: CCxIF flag is set, Corresponding interrupt or DMA request is sent if enabled. If CCx is an input: The current value of the counter is captured in TIMx_CCR1 register.
            pub const Trigger: u32 = 0b1;
        }
        /// Read-write values (empty)
        pub mod RW {}
...
pub mod OR {
    ...
    pub mod TI1_RMP {
        ...
        pub mod RW {
            ...
            /// 0b000: TIM2x TI1 input connected to GPIO
            pub const GPIO: u32 = 0b000;

            /// 0b001: TIM2x TI1 input connected to COMP2_OUT
            pub const COMP2_OUT: u32 = 0b001;

            /// 0b010: TIM2x TI1 input connected to COMP1_OUT
            pub const COMP1_OUT: u32 = 0b010;
        }
    }
