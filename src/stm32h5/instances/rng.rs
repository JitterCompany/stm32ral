...
pub use crate::stm32h5::peripherals::rng::Instance;
pub use crate::stm32h5::peripherals::rng::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::rng::{CR, DR, HTCR, SR};
