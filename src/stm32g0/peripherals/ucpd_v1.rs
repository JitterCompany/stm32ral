...
pub struct RegisterBlock {
    ...
    /// UCPD Tx Ordered Set Type Register
    pub TX_ORDSET: RWRegister<u32>,

    /// UCPD Tx Paysize Register
    pub TX_PAYSZ: RWRegister<u32>,

    /// UCPD Tx Data Register
    pub TXDR: RWRegister<u32>,

    /// UCPD Rx Ordered Set Register
    pub RX_ORDSET: RORegister<u32>,

    /// UCPD Rx Paysize Register
    pub RX_PAYSZ: RWRegister<u32>,

    /// UCPD Receive Data Register
    pub RXDR: RORegister<u32>,

    /// UCPD Rx Ordered Set Extension Register
    pub RX_ORDEXT1: RWRegister<u32>,

    /// UCPD Rx Ordered Set Extension Register
    pub RX_ORDEXT2: RWRegister<u32>,

    _reserved1: [u8; 952],

    /// UCPD IP ID register
    pub IPVER: RORegister<u32>,

    /// UCPD IP ID register
    pub IPID: RORegister<u32>,

    /// UCPD IP ID register
    pub MID: RORegister<u32>,
}
