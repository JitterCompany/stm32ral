...
pub mod UART10 {
    ...
    /// Reset values for each field in UART10
    ...
    #[no_mangle]
    static mut UART10_TAKEN: bool = false;

    /// Safe access to UART10
    ///
    ...
    /// Release exclusive access to UART10
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if UART10_TAKEN && inst.addr == INSTANCE.addr {
                UART10_TAKEN = false;
            } else {
...
pub const UART10: *const RegisterBlock = 0x40011c00 as *const _;
