...
pub use crate::stm32f7::peripherals::otg_fs_global_v1::{
    CID, DIEPTXF0, DIEPTXF1, DIEPTXF2, DIEPTXF3, DIEPTXF4, DIEPTXF5, GAHBCFG, GCCFG, GI2CCTL,
    GINTMSK, GINTSTS, GLPMCFG, GOTGCTL, GOTGINT, GRSTCTL, GRXFSIZ, GRXSTSP, GRXSTSR, GUSBCFG,
    HNPTXSTS, HPTXFSIZ,
};
