...
pub use crate::stm32g4::peripherals::dma::{
    CR1, CR2, CR3, CR4, CR5, CR6, CR7, CR8, IFCR, ISR, MAR1, MAR2, MAR3, MAR4, MAR5, MAR6, MAR7,
    MAR8, NDTR1, NDTR2, NDTR3, NDTR4, NDTR5, NDTR6, NDTR7, NDTR8, PAR1, PAR2, PAR3, PAR4, PAR5,
    PAR6, PAR7, PAR8,
};
