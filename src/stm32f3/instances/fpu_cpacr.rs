...
pub use crate::stm32f3::peripherals::fpu_cpacr::Instance;
pub use crate::stm32f3::peripherals::fpu_cpacr::CPACR;
pub use crate::stm32f3::peripherals::fpu_cpacr::{RegisterBlock, ResetValues};
