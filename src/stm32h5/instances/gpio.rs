...
pub use crate::stm32h5::peripherals::gpio::Instance;
pub use crate::stm32h5::peripherals::gpio::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::gpio::{
    AFRH, AFRL, BRR, BSRR, HSLVR, IDR, LCKR, MODER, ODR, OSPEEDR, OTYPER, PUPDR, SECCFGR,
};
