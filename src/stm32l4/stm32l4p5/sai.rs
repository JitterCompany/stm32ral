...
pub mod GCR {
    ...
    pub mod SYNCOUT {
        ...
        pub mod RW {
            ...
            /// 0b00: No synchronization output signals. SYNCOUT\[1:0\] should be configured as “No synchronization output signals” when audio block is configured as SPDIF
            pub const Disabled: u32 = 0b00;

            /// 0b01: Block A used for further synchronization for others SAI
            pub const BlockA: u32 = 0b01;

            /// 0b10: Block B used for further synchronization for others SAI
            pub const BlockB: u32 = 0b10;
        }
    }
...
pub mod CR1A {
    ...
    pub mod OSR {
        ...
        pub mod RW {
            ...
            /// 0b0: Master clock frequency = FFS x 256
            pub const Multiplier256: u32 = 0b0;

            /// 0b1: Master clock frequency = FFS x 512
            pub const Multiplier512: u32 = 0b1;
        }
    }
    ...
    pub mod NOMCK {
        ...
        pub mod RW {
            ...
            /// 0b1: Master clock generator is disabled. The clock divider controlled by MCKDIV can still be used to generate the bit clock
...
pub mod CR2A {
    ...
    pub mod TRIS {
        ...
        pub mod RW {
            ...
            /// 0b0: SD output line is still driven by the SAI when a slot is inactive
            pub const DrivenWhileInactive: u32 = 0b0;

            /// 0b1: SD output line is released (HI-Z) at the end of the last data bit of the last active slot if the next one is inactive
