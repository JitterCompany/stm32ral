...
pub use crate::stm32f7::peripherals::otg_hs_global::Instance;
pub use crate::stm32f7::peripherals::otg_hs_global::{RegisterBlock, ResetValues};
pub use crate::stm32f7::peripherals::otg_hs_global::{
