...
/// TIM4_CCMR1_Input and TIM4_CCMR1_Output
/// TIM4_CCMR1_Input: TIM4 capture/compare mode register 1 \\[alternate\\]
/// TIM4_CCMR1_Output: TIM4 capture/compare mode register 1 \\[alternate\\]
pub mod TIM4_CCMR1 {
...
/// TIM4_CCMR2_Input and TIM4_CCMR2_Output
/// TIM4_CCMR2_Input: TIM4 capture/compare mode register 2 \\[alternate\\]
/// TIM4_CCMR2_Output: TIM4 capture/compare mode register 2 \\[alternate\\]
pub mod TIM4_CCMR2 {
...
pub struct RegisterBlock {
    /// TIM4 control register 1
    pub TIM4_CR1: RWRegister<u16>,

    _reserved1: [u8; 2],

    /// TIM4 control register 2
    pub TIM4_CR2: RWRegister<u32>,

    /// TIM4 slave mode control register
    pub TIM4_SMCR: RWRegister<u32>,

    /// TIM4 DMA/Interrupt enable register
    pub TIM4_DIER: RWRegister<u32>,

    /// TIM4 status register
    pub TIM4_SR: RWRegister<u32>,

    /// TIM4 event generation register
    pub TIM4_EGR: WORegister<u16>,
    ...
    /// TIM4_CCMR1_Input: TIM4 capture/compare mode register 1 \\[alternate\\]
    /// TIM4_CCMR1_Output: TIM4 capture/compare mode register 1 \\[alternate\\]
    pub TIM4_CCMR1: RWRegister<u32>,

    /// TIM4_CCMR2_Input and TIM4_CCMR2_Output
    /// TIM4_CCMR2_Input: TIM4 capture/compare mode register 2 \\[alternate\\]
    /// TIM4_CCMR2_Output: TIM4 capture/compare mode register 2 \\[alternate\\]
    pub TIM4_CCMR2: RWRegister<u32>,

    /// TIM4 capture/compare enable register
    pub TIM4_CCER: RWRegister<u16>,

    _reserved3: [u8; 2],

    /// TIM4 counter
    pub TIM4_CNT: RWRegister<u32>,

    /// TIM4 prescaler
    pub TIM4_PSC: RWRegister<u16>,

    _reserved4: [u8; 2],

    /// TIM4 auto-reload register
    pub TIM4_ARR: RWRegister<u32>,

    _reserved5: [u8; 4],

    /// TIM4 capture/compare register 1
    pub TIM4_CCR1: RWRegister<u32>,

    /// TIM4 capture/compare register 2
    pub TIM4_CCR2: RWRegister<u32>,

    /// TIM4 capture/compare register 3
    pub TIM4_CCR3: RWRegister<u32>,

    /// TIM4 capture/compare register 4
    pub TIM4_CCR4: RWRegister<u32>,

    _reserved6: [u8; 20],

    /// TIM4 timer encoder control register
    pub TIM4_ECR: RWRegister<u32>,

    /// TIM4 timer input selection register
    pub TIM4_TISEL: RWRegister<u32>,

    /// TIM4 alternate function register 1
    pub TIM4_AF1: RWRegister<u32>,

    /// TIM4 alternate function register 2
    pub TIM4_AF2: RWRegister<u32>,

    _reserved7: [u8; 884],

    /// TIM4 DMA control register
    pub TIM4_DCR: RWRegister<u32>,

    /// TIM4 DMA address for full transfer
    pub TIM4_DMAR: RWRegister<u32>,
}
