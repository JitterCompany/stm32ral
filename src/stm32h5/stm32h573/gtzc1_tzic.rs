...
pub mod GTZC1_TZIC_IER1 {
    ...
    /// illegal access interrupt enable for TIM13
    pub mod TIM13IE {
        /// Offset (7 bits)
    ...
    /// illegal access interrupt enable for TIM14
    pub mod TIM14IE {
        /// Offset (8 bits)
    ...
    /// illegal access interrupt enable for USART6
    pub mod USART6IE {
        /// Offset (21 bits)
    ...
    /// illegal access interrupt enable for USART10
    pub mod USART10IE {
        /// Offset (22 bits)
    ...
    /// illegal access interrupt enable for USART11
    pub mod USART11IE {
        /// Offset (23 bits)
    ...
    /// illegal access interrupt enable for HDMICEC
    pub mod HDMICECIE {
        /// Offset (24 bits)
    ...
    /// illegal access interrupt enable for UART7
    pub mod UART7IE {
        /// Offset (26 bits)
    ...
    /// illegal access interrupt enable for UART8
    pub mod UART8IE {
        /// Offset (27 bits)
    ...
    /// illegal access interrupt enable for UART9
    pub mod UART9IE {
        /// Offset (28 bits)
    ...
    /// illegal access interrupt enable for UART12
    pub mod UART12IE {
        /// Offset (29 bits)
    ...
    /// illegal access interrupt enable for DTS
    pub mod DTSIE {
        /// Offset (30 bits)
...
pub mod GTZC1_TZIC_IER2 {
    ...
    /// illegal access interrupt enable for UCPD
    pub mod UCPDIE {
        /// Offset (2 bits)
        pub const offset: u32 = 2;
        /// Mask (1 bit: 1 << 2)
    ...
    /// illegal access interrupt enable for SPI6
    pub mod SPI6IE {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
        /// Mask (1 bit: 1 << 16)
    ...
    /// illegal access interrupt enable for SPI5
    pub mod SPI5IE {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// illegal access interrupt enable for LPUART
    pub mod LPUART1IE {
        /// Offset (25 bits)
        pub const offset: u32 = 25;
        /// Mask (1 bit: 1 << 25)
    ...
    /// illegal access interrupt enable for LPTIM5
    pub mod LPTIM5IE {
        /// Offset (31 bits)
        pub const offset: u32 = 31;
        /// Mask (1 bit: 1 << 31)
...
pub mod GTZC1_TZIC_IER3 {
    ...
    /// illegal access interrupt enable for LPTIM6
    pub mod LPTIM6IE {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
    ...
    /// illegal access interrupt enable for register of ETH
    pub mod ETHIE {
        /// Offset (11 bits)
        pub const offset: u32 = 11;
        /// Mask (1 bit: 1 << 11)
    ...
    /// illegal access interrupt enable for ICACHE
    pub mod ICACHEIE {
        /// Offset (12 bits)
        pub const offset: u32 = 12;
        /// Mask (1 bit: 1 << 12)
    ...
    /// illegal access interrupt enable for DCACHE
    pub mod DCACHEIE {
        /// Offset (13 bits)
        pub const offset: u32 = 13;
        /// Mask (1 bit: 1 << 13)
    ...
    /// illegal access interrupt enable for FMC
    pub mod FMCIE {
        /// Offset (23 bits)
        pub const offset: u32 = 23;
        /// Mask (1 bit: 1 << 23)
    ...
    /// illegal access interrupt enable for OCTOSPI1
    pub mod OCTOSPI1IE {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// illegal access interrupt enable for RAMSCFG
    pub mod RAMCFGIE {
        /// Offset (26 bits)
        pub const offset: u32 = 26;
        /// Mask (1 bit: 1 << 26)
...
pub mod GTZC1_TZIC_IER4 {
    ...
    /// illegal access interrupt enable for GPDMA2
    pub mod GPDMA2IE {
        /// Offset (1 bits)
        pub const offset: u32 = 1;
        /// Mask (1 bit: 1 << 1)
    ...
    /// illegal access interrupt enable for SBS
    pub mod SBSIE {
        /// Offset (6 bits)
        pub const offset: u32 = 6;
        /// Mask (1 bit: 1 << 6)
    ...
    /// illegal access interrupt enable for MPCWM2 (FMC_NOR bank), MPCWM3 (FMC_NAND bank and FMC_SDRAM bank 1), and MPCWM4 (FMC_SDRAM�bank 2)
    pub mod FMC_MEMIE {
        /// Offset (19 bits)
        pub const offset: u32 = 19;
        /// Mask (1 bit: 1 << 19)
    ...
    /// illegal access interrupt enable for MPCWM4 (BKPSRAM) memory bank
    pub mod BKPSRAMIE {
        /// Offset (20 bits)
        pub const offset: u32 = 20;
        /// Mask (1 bit: 1 << 20)
...
pub mod GTZC1_TZIC_SR1 {
    ...
    /// illegal access flag for USART6
    pub mod USART6F {
        /// Offset (21 bits)
        pub const offset: u32 = 21;
        /// Mask (1 bit: 1 << 21)
    ...
    /// illegal access flag for USART10
    pub mod USART10F {
        /// Offset (22 bits)
        pub const offset: u32 = 22;
        /// Mask (1 bit: 1 << 22)
    ...
    /// illegal access flag for USART11
    pub mod USART11F {
        /// Offset (23 bits)
        pub const offset: u32 = 23;
        /// Mask (1 bit: 1 << 23)
    ...
    /// illegal access flag for HDMICEC
    pub mod HDMICECF {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// illegal access flag for UART12
    pub mod UART12F {
        /// Offset (29 bits)
        pub const offset: u32 = 29;
        /// Mask (1 bit: 1 << 29)
...
pub mod GTZC1_TZIC_SR2 {
    ...
    /// illegal access flag for FDCAN1
    pub mod FDCAN1F {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
    ...
    /// illegal access flag for LPUART
    pub mod LPUART1F {
        /// Offset (25 bits)
        pub const offset: u32 = 25;
        /// Mask (1 bit: 1 << 25)
    ...
    /// illegal access flag for LPTIM5
    pub mod LPTIM5F {
        /// Offset (31 bits)
        pub const offset: u32 = 31;
        /// Mask (1 bit: 1 << 31)
...
pub mod GTZC1_TZIC_SR3 {
    ...
    /// illegal access flag for LPTIM6
    pub mod LPTIM6F {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
    ...
    /// illegal access flag for CORDIC
    pub mod CORDICF {
        /// Offset (9 bits)
        pub const offset: u32 = 9;
        /// Mask (1 bit: 1 << 9)
    ...
    /// illegal access flag for register of ETH
    pub mod ETHF {
        /// Offset (11 bits)
        pub const offset: u32 = 11;
        /// Mask (1 bit: 1 << 11)
    ...
    /// illegal access flag for ICACHE
    pub mod ICACHEF {
        /// Offset (12 bits)
        pub const offset: u32 = 12;
        /// Mask (1 bit: 1 << 12)
    ...
    /// illegal access flag for SDMMC2
    pub mod SDMMC2F {
        /// Offset (21 bits)
        pub const offset: u32 = 21;
        /// Mask (1 bit: 1 << 21)
    ...
    /// illegal access flag for OCTOSPI1
    pub mod OCTOSPI1F {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// illegal access flag for RAMSCFG
    pub mod RAMCFGF {
        /// Offset (26 bits)
        pub const offset: u32 = 26;
        /// Mask (1 bit: 1 << 26)
...
pub mod GTZC1_TZIC_SR4 {
    ...
    /// illegal access flag for GPDMA2
    pub mod GPDMA2F {
        /// Offset (1 bits)
        pub const offset: u32 = 1;
        /// Mask (1 bit: 1 << 1)
    ...
    /// illegal access flag for OTFDEC1
    pub mod OTFDEC1F {
        /// Offset (4 bits)
        pub const offset: u32 = 4;
        /// Mask (1 bit: 1 << 4)
    ...
    /// illegal access flag for MPCWM1 (OCTOSPI1) memory bank
    pub mod OCTOSPI1_MEMF {
        /// Offset (18 bits)
        pub const offset: u32 = 18;
        /// Mask (1 bit: 1 << 18)
        pub const mask: u32 = 1 << offset;
    ...
    /// illegal access flag for MPCWM2 (FMC_NOR bank), MPCWM3 (FMC_NAND bank and FMC_SDRAM bank 1), and MPCWM4 (FMC_SDRAM�bank 2)
    pub mod FMC_MEMF {
        /// Offset (19 bits)
        pub const offset: u32 = 19;
        /// Mask (1 bit: 1 << 19)
    ...
    /// illegal access flag for MPCWM4 (BKPSRAM) memory bank
    pub mod BKPSRAMF {
        /// Offset (20 bits)
        pub const offset: u32 = 20;
        /// Mask (1 bit: 1 << 20)
...
pub mod GTZC1_TZIC_FCR1 {
    ...
    /// clear the illegal access flag for TIM5
    pub mod CTIM5F {
        /// Offset (3 bits)
        pub const offset: u32 = 3;
        /// Mask (1 bit: 1 << 3)
    ...
    /// clear the illegal access flag for TIM13
    pub mod CTIM13F {
        /// Offset (7 bits)
        pub const offset: u32 = 7;
        /// Mask (1 bit: 1 << 7)
    ...
    /// clear the illegal access flag for TIM14
    pub mod CTIM14F {
        /// Offset (8 bits)
        pub const offset: u32 = 8;
        /// Mask (1 bit: 1 << 8)
    ...
    /// clear the illegal access flag for USART6
    pub mod CUSART6F {
        /// Offset (21 bits)
        pub const offset: u32 = 21;
        /// Mask (1 bit: 1 << 21)
    ...
    /// clear the illegal access flag for USART10
    pub mod CUSART10F {
        /// Offset (22 bits)
        pub const offset: u32 = 22;
        /// Mask (1 bit: 1 << 22)
    ...
    /// clear the illegal access flag for USART11
    pub mod CUSART11F {
        /// Offset (23 bits)
        pub const offset: u32 = 23;
        /// Mask (1 bit: 1 << 23)
    ...
    /// clear the illegal access flag for HDMICEC
    pub mod CHDMICECF {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// clear the illegal access flag for UART7
    pub mod CUART7F {
        /// Offset (26 bits)
        pub const offset: u32 = 26;
        /// Mask (1 bit: 1 << 26)
    ...
    /// clear the illegal access flag for UART8
    pub mod CUART8F {
        /// Offset (27 bits)
        pub const offset: u32 = 27;
        /// Mask (1 bit: 1 << 27)
    ...
    /// clear the illegal access flag for UART9
    pub mod CUART9F {
        /// Offset (28 bits)
        pub const offset: u32 = 28;
        /// Mask (1 bit: 1 << 28)
    ...
    /// clear the illegal access flag for UART12
    pub mod CUART12F {
        /// Offset (29 bits)
        pub const offset: u32 = 29;
        /// Mask (1 bit: 1 << 29)
    ...
    /// clear the illegal access flag for DTS
    pub mod CDTSF {
        /// Offset (30 bits)
        pub const offset: u32 = 30;
        /// Mask (1 bit: 1 << 30)
...
pub mod GTZC1_TZIC_FCR2 {
    ...
    /// clear the illegal access flag for FDCAN1
    pub mod CFDCAN1F {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
    ...
    /// clear the illegal access flag for UCPD
    pub mod CUCPDF {
        /// Offset (2 bits)
        pub const offset: u32 = 2;
        /// Mask (1 bit: 1 << 2)
    ...
    /// clear the illegal access flag for SPI6
    pub mod CSPI6F {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
        /// Mask (1 bit: 1 << 16)
    ...
    /// clear the illegal access flag for SAI2
    pub mod CSAI2F {
        /// Offset (18 bits)
        pub const offset: u32 = 18;
        /// Mask (1 bit: 1 << 18)
    ...
    /// clear the illegal access flag for SPI5
    pub mod CSPI5F {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// clear the illegal access flag for LPUART
    pub mod CLPUART1F {
        /// Offset (25 bits)
        pub const offset: u32 = 25;
        /// Mask (1 bit: 1 << 25)
    ...
    /// clear the illegal access flag for LPTIM5
    pub mod CLPTIM5F {
        /// Offset (31 bits)
        pub const offset: u32 = 31;
        /// Mask (1 bit: 1 << 31)
...
pub mod GTZC1_TZIC_FCR3 {
    ...
    /// clear illegal access flag for LPTIM6
    pub mod CLPTIM6F {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
        /// Mask (1 bit: 1 << 0)
    ...
    /// clear illegal access flag for VREFBUF
    pub mod CVREFBUFF {
        /// Offset (1 bits)
        pub const offset: u32 = 1;
        /// Mask (1 bit: 1 << 1)
    ...
    /// clear illegal access flag for CRC
    pub mod CCRCF {
        /// Offset (8 bits)
        pub const offset: u32 = 8;
        /// Mask (1 bit: 1 << 8)
    ...
    /// clear illegal access flag for CORDIC
    pub mod CCORDICF {
        /// Offset (9 bits)
        pub const offset: u32 = 9;
        /// Mask (1 bit: 1 << 9)
    ...
    /// clear illegal access flag for FMAC
    pub mod CFMACF {
        /// Offset (10 bits)
        pub const offset: u32 = 10;
        /// Mask (1 bit: 1 << 10)
    ...
    /// clear illegal access flag for register of ETH
    pub mod CETHF {
        /// Offset (11 bits)
        pub const offset: u32 = 11;
        /// Mask (1 bit: 1 << 11)
    ...
    /// clear illegal access flag for ICACHE
    pub mod CICACHEF {
        /// Offset (12 bits)
        pub const offset: u32 = 12;
        /// Mask (1 bit: 1 << 12)
    ...
    /// clear illegal access flag for DCACHE
    pub mod CDCACHEF {
        /// Offset (13 bits)
        pub const offset: u32 = 13;
        /// Mask (1 bit: 1 << 13)
    ...
    /// clear illegal access flag for ADC1 and ADC2
    pub mod CADC12F {
        /// Offset (14 bits)
        pub const offset: u32 = 14;
        /// Mask (1 bit: 1 << 14)
    ...
    /// clear illegal access flag for DCMI
    pub mod CDCMIF {
        /// Offset (15 bits)
        pub const offset: u32 = 15;
        /// Mask (1 bit: 1 << 15)
    ...
    /// clear illegal access flag for AES
    pub mod CAESF {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
        /// Mask (1 bit: 1 << 16)
    ...
    /// clear illegal access flag for HASH
    pub mod CHASHF {
        /// Offset (17 bits)
        pub const offset: u32 = 17;
        /// Mask (1 bit: 1 << 17)
    ...
    /// clear illegal access flag for RNG
    pub mod CRNGF {
        /// Offset (18 bits)
        pub const offset: u32 = 18;
        /// Mask (1 bit: 1 << 18)
    ...
    /// clear illegal access flag for SAES
    pub mod CSAESF {
        /// Offset (19 bits)
        pub const offset: u32 = 19;
        /// Mask (1 bit: 1 << 19)
    ...
    /// clear illegal access flag for PKA
    pub mod CPKAF {
        /// Offset (20 bits)
        pub const offset: u32 = 20;
        /// Mask (1 bit: 1 << 20)
    ...
    /// clear illegal access flag for SDMMC2
    pub mod CSDMMC2F {
        /// Offset (21 bits)
        pub const offset: u32 = 21;
        /// Mask (1 bit: 1 << 21)
    ...
    /// clear illegal access flag for SDMMC1
    pub mod CSDMMC1F {
        /// Offset (22 bits)
        pub const offset: u32 = 22;
        /// Mask (1 bit: 1 << 22)
    ...
    /// clear illegal access flag for FMC
    pub mod CFMCF {
        /// Offset (23 bits)
        pub const offset: u32 = 23;
        /// Mask (1 bit: 1 << 23)
    ...
    /// clear illegal access flag for OCTOSPI1
    pub mod COCTOSPI1F {
        /// Offset (24 bits)
        pub const offset: u32 = 24;
        /// Mask (1 bit: 1 << 24)
    ...
    /// clear illegal access flag for RAMSCFG
    pub mod CRAMCFGF {
        /// Offset (26 bits)
        pub const offset: u32 = 26;
        /// Mask (1 bit: 1 << 26)
...
pub mod GTZC1_TZIC_FCR4 {
    ...
    /// clear the illegal access flag for GPDMA2
    pub mod CGPDMA2F {
        /// Offset (1 bits)
        pub const offset: u32 = 1;
        /// Mask (1 bit: 1 << 1)
    ...
    /// clear the illegal access flag for OTFDEC1
    pub mod COTFDEC1F {
        /// Offset (4 bits)
        pub const offset: u32 = 4;
        /// Mask (1 bit: 1 << 4)
    ...
    /// clear the illegal access flag for SBS
    pub mod CSBSF {
        /// Offset (6 bits)
        pub const offset: u32 = 6;
        /// Mask (1 bit: 1 << 6)
    ...
    /// clear the illegal access flag for MPCWM1 (OCTOSPI1) memory bank
    pub mod COCTOSPI1_MEMF {
        /// Offset (18 bits)
        pub const offset: u32 = 18;
        /// Mask (1 bit: 1 << 18)
        pub const mask: u32 = 1 << offset;
    ...
    /// clear the illegal access flag for MPCWM2 (FMC_NOR bank), MPCWM3 (FMC_NAND bank and FMC_SDRAM bank 1), and MPCWM4 (FMC_SDRAM�bank 2)
    pub mod CFMC_MEMF {
        /// Offset (19 bits)
        pub const offset: u32 = 19;
        /// Mask (1 bit: 1 << 19)
    ...
    /// clear the illegal access flag for MPCWM4 (BKPSRAM) memory bank
    pub mod CBKPSRAMF {
        /// Offset (20 bits)
        pub const offset: u32 = 20;
        /// Mask (1 bit: 1 << 20)
...
pub struct RegisterBlock {
    /// TZIC interrupt enable register 1
    pub GTZC1_TZIC_IER1: RWRegister<u32>,

    /// GTZC1 TZIC interrupt enable register 2
    pub GTZC1_TZIC_IER2: RWRegister<u32>,

    /// GTZC1 TZIC interrupt enable register 3
    pub GTZC1_TZIC_IER3: RWRegister<u32>,

    /// GTZC1 TZIC interrupt enable register 4
    pub GTZC1_TZIC_IER4: RWRegister<u32>,

    /// TZIC status register 1
    pub GTZC1_TZIC_SR1: RORegister<u32>,

    /// TZIC status register 2
    pub GTZC1_TZIC_SR2: RORegister<u32>,

    /// TZIC status register 3
    pub GTZC1_TZIC_SR3: RORegister<u32>,

    /// GTZC1 TZIC status register 4
    pub GTZC1_TZIC_SR4: RORegister<u32>,

    /// TZIC flag clear register 1
    pub GTZC1_TZIC_FCR1: WORegister<u32>,

    /// TZIC flag clear register 2
    pub GTZC1_TZIC_FCR2: WORegister<u32>,

    /// TZIC flag clear register 3
    pub GTZC1_TZIC_FCR3: WORegister<u32>,

    /// GTZC1 TZIC flag clear register 4
    pub GTZC1_TZIC_FCR4: WORegister<u32>,
}
pub struct ResetValues {
    pub GTZC1_TZIC_IER1: u32,
    pub GTZC1_TZIC_IER2: u32,
    pub GTZC1_TZIC_IER3: u32,
    pub GTZC1_TZIC_IER4: u32,
    pub GTZC1_TZIC_SR1: u32,
    pub GTZC1_TZIC_SR2: u32,
    pub GTZC1_TZIC_SR3: u32,
    pub GTZC1_TZIC_SR4: u32,
    pub GTZC1_TZIC_FCR1: u32,
    pub GTZC1_TZIC_FCR2: u32,
    pub GTZC1_TZIC_FCR3: u32,
    pub GTZC1_TZIC_FCR4: u32,
}
#[cfg(not(feature = "nosync"))]
pub struct Instance {
    pub(crate) addr: u32,
...
/// Access functions for the GTZC1_TZIC peripheral instance
pub mod GTZC1_TZIC {
    ...
    /// Reset values for each field in GTZC1_TZIC
    pub const reset: ResetValues = ResetValues {
        GTZC1_TZIC_IER1: 0x00000000,
        GTZC1_TZIC_IER2: 0x00000000,
        GTZC1_TZIC_IER3: 0x00000000,
        GTZC1_TZIC_IER4: 0x00000000,
        GTZC1_TZIC_SR1: 0x00000000,
        GTZC1_TZIC_SR2: 0x00000000,
        GTZC1_TZIC_SR3: 0x00000000,
        GTZC1_TZIC_SR4: 0x00000000,
        GTZC1_TZIC_FCR1: 0x00000000,
        GTZC1_TZIC_FCR2: 0x00000000,
        GTZC1_TZIC_FCR3: 0x00000000,
        GTZC1_TZIC_FCR4: 0x00000000,
    };
    ...
    #[no_mangle]
    static mut GTZC1_TZIC_TAKEN: bool = false;

    /// Safe access to GTZC1_TZIC
    ///
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if GTZC1_TZIC_TAKEN {
                ...
                GTZC1_TZIC_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to GTZC1_TZIC
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if GTZC1_TZIC_TAKEN && inst.addr == INSTANCE.addr {
                GTZC1_TZIC_TAKEN = false;
            } else {
...
pub const GTZC1_TZIC: *const RegisterBlock = 0x40032800 as *const _;

/// Access functions for the SEC_GTZC1_TZIC peripheral instance
pub mod SEC_GTZC1_TZIC {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_GTZC1_TZIC
    pub const reset: ResetValues = ResetValues {
        GTZC1_TZIC_IER1: 0x00000000,
        GTZC1_TZIC_IER2: 0x00000000,
        GTZC1_TZIC_IER3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_GTZC1_TZIC_TAKEN: bool = false;

    /// Safe access to SEC_GTZC1_TZIC
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_GTZC1_TZIC_TAKEN {
                None
            } else {
                SEC_GTZC1_TZIC_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_GTZC1_TZIC
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_GTZC1_TZIC_TAKEN && inst.addr == INSTANCE.addr {
                SEC_GTZC1_TZIC_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_GTZC1_TZIC: *const RegisterBlock = 0x50032800 as *const _;
