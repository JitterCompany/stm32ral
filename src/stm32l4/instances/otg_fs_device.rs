...
pub use crate::stm32l4::peripherals::otg_fs_device::Instance;
pub use crate::stm32l4::peripherals::otg_fs_device::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::otg_fs_device::{
    CTL, CTL, CTL1, CTL1, CTL2, CTL2, CTL3, CTL3, CTL4, CTL4, CTL5, CTL5, DAINT, DAINTMSK, DCFG,
    DCTL, DIEPEMPMSK, DIEPMSK, DOEPMSK, DSTS, DVBUSDIS, DVBUSPULSE, INT, INT, INT1, INT1, INT2,
    INT2, INT3, INT3, INT4, INT4, INT5, INT5, TSIZ, TSIZ, TSIZ1, TSIZ1, TSIZ2, TSIZ2, TSIZ3, TSIZ3,
    TSIZ4, TSIZ4, TSIZ5, TSIZ5, TXFSTS, TXFSTS1, TXFSTS2, TXFSTS3, TXFSTS4, TXFSTS5,
};
