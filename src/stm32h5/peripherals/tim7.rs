...
pub struct RegisterBlock {
    /// TIM7 control register 1
    pub TIM7_CR1: RWRegister<u16>,

    _reserved1: [u8; 2],

    /// TIM7 control register 2
    pub TIM7_CR2: RWRegister<u16>,

    _reserved2: [u8; 6],

    /// TIM7 DMA/Interrupt enable register
    pub TIM7_DIER: RWRegister<u16>,

    _reserved3: [u8; 2],

    /// TIM7 status register
    pub TIM7_SR: RWRegister<u16>,

    _reserved4: [u8; 2],

    /// TIM7 event generation register
    pub TIM7_EGR: WORegister<u16>,

    _reserved5: [u8; 14],

    /// TIM7 counter
    pub TIM7_CNT: RWRegister<u32>,

    /// TIM7 prescaler
    pub TIM7_PSC: RWRegister<u16>,

    _reserved6: [u8; 2],

    /// TIM7 auto-reload register
    pub TIM7_ARR: RWRegister<u32>,
}
