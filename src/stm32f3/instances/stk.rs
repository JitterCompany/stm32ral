...
pub use crate::stm32f3::peripherals::stk::Instance;
pub use crate::stm32f3::peripherals::stk::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::stk::{CALIB, CTRL, LOAD, VAL};
