...
pub use crate::stm32f7::peripherals::otg_fs_pwrclk::Instance;
pub use crate::stm32f7::peripherals::otg_fs_pwrclk::PCGCCTL;
pub use crate::stm32f7::peripherals::otg_fs_pwrclk::{RegisterBlock, ResetValues};
