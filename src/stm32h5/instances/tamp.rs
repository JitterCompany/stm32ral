...
pub use crate::stm32h5::peripherals::tamp::Instance;
pub use crate::stm32h5::peripherals::tamp::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::tamp::{
    ...
    BKP28R, BKP29R, BKP2R, BKP30R, BKP31R, BKP3R, BKP4R, BKP5R, BKP6R, BKP7R, BKP8R, BKP9R,
    COUNT1R, CR1, CR2, CR3, ERCFGR, FLTCR, IER, MISR, OR, PRIVCFGR, SCR, SECCFGR, SMISR, SR,
};
...
pub const SEC_TAMP: *const RegisterBlock = 0x54007c00 as *const _;
