...
pub use crate::stm32g0::peripherals::hdmi_cec_v2::Instance;
pub use crate::stm32g0::peripherals::hdmi_cec_v2::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::hdmi_cec_v2::{
