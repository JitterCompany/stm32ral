...
//!
//! Used by: stm32f301, stm32f302, stm32f303, stm32f373, stm32f3x4
...
pub mod IOASCR {
    ...
    pub use super::IOHCR::G7_IO1;
    pub use super::IOHCR::G7_IO2;
    pub use super::IOHCR::G7_IO3;
    pub use super::IOHCR::G7_IO4;
    pub use super::IOHCR::G8_IO1;
    pub use super::IOHCR::G8_IO2;
    pub use super::IOHCR::G8_IO3;
    pub use super::IOHCR::G8_IO4;
}
