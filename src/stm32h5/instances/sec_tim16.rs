...
/// Access functions for the SEC_TIM16 peripheral instance
pub mod SEC_TIM16 {
    ...
    /// Reset values for each field in SEC_TIM16
    ...
    #[no_mangle]
    static mut SEC_TIM16_TAKEN: bool = false;

    /// Safe access to SEC_TIM16
    ///
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_TIM16_TAKEN {
                ...
                SEC_TIM16_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_TIM16
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_TIM16_TAKEN && inst.addr == INSTANCE.addr {
                SEC_TIM16_TAKEN = false;
            } else {
...
pub const SEC_TIM16: *const RegisterBlock = 0x50014400 as *const _;
