...
/// TIM2_CCMR1_Input and TIM2_CCMR1_Output
/// TIM2_CCMR1_Input: TIM2 capture/compare mode register 1 \\[alternate\\]
/// TIM2_CCMR1_Output: TIM2 capture/compare mode register 1 \\[alternate\\]
pub mod TIM2_CCMR1 {
...
/// TIM2_CCMR2_Input and TIM2_CCMR2_Output
/// TIM2_CCMR2_Input: TIM2 capture/compare mode register 2 \\[alternate\\]
/// TIM2_CCMR2_Output: TIM2 capture/compare mode register 2 \\[alternate\\]
pub mod TIM2_CCMR2 {
...
pub struct RegisterBlock {
    /// TIM2 control register 1
    pub TIM2_CR1: RWRegister<u16>,

    _reserved1: [u8; 2],

    /// TIM2 control register 2
    pub TIM2_CR2: RWRegister<u32>,

    /// TIM2 slave mode control register
    pub TIM2_SMCR: RWRegister<u32>,

    /// TIM2 DMA/Interrupt enable register
    pub TIM2_DIER: RWRegister<u32>,

    /// TIM2 status register
    pub TIM2_SR: RWRegister<u32>,

    /// TIM2 event generation register
    pub TIM2_EGR: WORegister<u16>,
    ...
    /// TIM2_CCMR1_Input: TIM2 capture/compare mode register 1 \\[alternate\\]
    /// TIM2_CCMR1_Output: TIM2 capture/compare mode register 1 \\[alternate\\]
    pub TIM2_CCMR1: RWRegister<u32>,

    /// TIM2_CCMR2_Input and TIM2_CCMR2_Output
    /// TIM2_CCMR2_Input: TIM2 capture/compare mode register 2 \\[alternate\\]
    /// TIM2_CCMR2_Output: TIM2 capture/compare mode register 2 \\[alternate\\]
    pub TIM2_CCMR2: RWRegister<u32>,

    /// TIM2 capture/compare enable register
    pub TIM2_CCER: RWRegister<u16>,

    _reserved3: [u8; 2],

    /// TIM2 counter
    pub TIM2_CNT: RWRegister<u32>,

    /// TIM2 prescaler
    pub TIM2_PSC: RWRegister<u16>,

    _reserved4: [u8; 2],

    /// TIM2 auto-reload register
    pub TIM2_ARR: RWRegister<u32>,

    _reserved5: [u8; 4],

    /// TIM2 capture/compare register 1
    pub TIM2_CCR1: RWRegister<u32>,

    /// TIM2 capture/compare register 2
    pub TIM2_CCR2: RWRegister<u32>,

    /// TIM2 capture/compare register 3
    pub TIM2_CCR3: RWRegister<u32>,

    /// TIM2 capture/compare register 4
    pub TIM2_CCR4: RWRegister<u32>,

    _reserved6: [u8; 20],

    /// TIM2 timer encoder control register
    pub TIM2_ECR: RWRegister<u32>,

    /// TIM2 timer input selection register
    pub TIM2_TISEL: RWRegister<u32>,

    /// TIM2 alternate function register 1
    pub TIM2_AF1: RWRegister<u32>,

    /// TIM2 alternate function register 2
    pub TIM2_AF2: RWRegister<u32>,

    _reserved7: [u8; 884],

    /// TIM2 DMA control register
    pub TIM2_DCR: RWRegister<u32>,

    /// TIM2 DMA address for full transfer
    pub TIM2_DMAR: RWRegister<u32>,
}
