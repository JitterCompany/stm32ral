...
pub use crate::stm32f4::peripherals::otg_fs_global_v4::Instance;
pub use crate::stm32f4::peripherals::otg_fs_global_v4::{RegisterBlock, ResetValues};
pub use crate::stm32f4::peripherals::otg_fs_global_v4::{
    CID, DIEPTXF0, DIEPTXF1, DIEPTXF2, DIEPTXF3, DIEPTXF4, DIEPTXF5, GAHBCFG, GCCFG, GINTMSK,
    GINTSTS, GLPMCFG, GOTGCTL, GOTGINT, GRSTCTL, GRXFSIZ, GRXSTSP, GRXSTSR, GUSBCFG, HNPTXSTS,
    HPTXFSIZ,
};
