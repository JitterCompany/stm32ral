...
/// Access functions for the TIM10 peripheral instance
pub mod TIM10 {
    ...
    /// Reset values for each field in TIM10
    ...
    #[no_mangle]
    static mut TIM10_TAKEN: bool = false;

    /// Safe access to TIM10
    ///
    ...
    /// Release exclusive access to TIM10
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if TIM10_TAKEN && inst.addr == INSTANCE.addr {
                TIM10_TAKEN = false;
            } else {
...
pub const TIM10: *const RegisterBlock = 0x40010c00 as *const _;
