...
pub use crate::stm32l4::peripherals::dma_v1::Instance;
pub use crate::stm32l4::peripherals::dma_v1::{RegisterBlock, ResetValues};
pub use crate::stm32l4::peripherals::dma_v1::{
    CR1, CR2, CR3, CR4, CR5, CR6, CR7, CSELR, IFCR, ISR, MAR1, MAR2, MAR3, MAR4, MAR5, MAR6, MAR7,
    NDTR1, NDTR2, NDTR3, NDTR4, NDTR5, NDTR6, NDTR7, PAR1, PAR2, PAR3, PAR4, PAR5, PAR6, PAR7,
};
