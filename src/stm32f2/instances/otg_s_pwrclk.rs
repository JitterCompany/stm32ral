...
pub use crate::stm32f2::peripherals::otg_s_pwrclk::Instance;
pub use crate::stm32f2::peripherals::otg_s_pwrclk::PCGCCTL;
pub use crate::stm32f2::peripherals::otg_s_pwrclk::{RegisterBlock, ResetValues};
