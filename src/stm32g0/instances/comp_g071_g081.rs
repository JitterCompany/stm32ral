...
pub use crate::stm32g0::peripherals::comp_v1::Instance;
pub use crate::stm32g0::peripherals::comp_v1::{RegisterBlock, ResetValues};
pub use crate::stm32g0::peripherals::comp_v1::{COMP1_CSR, COMP2_CSR};
