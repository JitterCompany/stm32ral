...
/// Access functions for the SEC_TIM12 peripheral instance
pub mod SEC_TIM12 {
    ...
    /// Reset values for each field in SEC_TIM12
    ...
    #[no_mangle]
    static mut SEC_TIM12_TAKEN: bool = false;

    /// Safe access to SEC_TIM12
    ///
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_TIM12_TAKEN {
                ...
                SEC_TIM12_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_TIM12
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_TIM12_TAKEN && inst.addr == INSTANCE.addr {
                SEC_TIM12_TAKEN = false;
            } else {
...
pub const SEC_TIM12: *const RegisterBlock = 0x50001800 as *const _;
