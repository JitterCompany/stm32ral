...
pub mod DCKCFGR {
    ...
    pub mod SAI1SRC {
        ...
        pub mod RW {
            ...
            /// 0b10: SAI1 clock frequency = f(PLL_R)
            pub const PLLR: u32 = 0b10;

            /// 0b11: I2S_CKIN Alternate function input frequency
            pub const I2S_CKIN: u32 = 0b11;
        }
    }
    ...
    pub mod SAI2SRC {
        ...
        pub mod RW {
            ...
            /// 0b10: SAI2 clock frequency = f(PLL_R)
            pub const PLLR: u32 = 0b10;

            /// 0b11: SAI2 clock frequency = Alternate function input frequency
...
pub mod DCKCFGR2 {
    ...
    pub mod SPDIFRXSEL {
        ...
        pub mod RW {
            ...
            /// 0b0: SPDIF-Rx clock from PLL is selected
            pub const PLL: u32 = 0b0;

            /// 0b1: SPDIF-Rx clock from PLLI2S is selected
            pub const PLLI2S: u32 = 0b1;
        }
    }
}
#[repr(C)]
