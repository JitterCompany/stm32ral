...
pub mod CR {
    ...
    /// HSI48 oscillator smooth trimming These bits provide a user-programmable trimming value to the HSI48 oscillator. They can be programmed to adjust to variations in voltage and temperature that influence the frequency of the HSI48 oscillator. The default value is 32, which corresponds to the middle of the trimming interval. The trimming step is specified in the product datasheet. A higher TRIM value corresponds to a higher output frequency. When the AUTOTRIMEN bit is set, this field is controlled by hardware and is read-only.
    pub mod TRIM {
        /// Offset (8 bits)
...
pub mod CFGR {
    ...
    /// Counter reload value RELOAD is the value to be loaded in the frequency error counter with each SYNC event. Refer to Section 10.5.2 for more details about counter behavior.
    pub mod RELOAD {
        /// Offset (0 bits)
        pub const offset: u32 = 0;
    ...
    /// Frequency error limit FELIM contains the value to be used to evaluate the captured frequency error value latched in the FECAP\[15:0\] bits of the CRS_ISR register. Refer to Section 10.5.3 for more details about FECAP evaluation.
    pub mod FELIM {
        /// Offset (16 bits)
...
pub mod ISR {
    ...
    /// Frequency error capture FECAP is the frequency error counter value latched in the time of the last SYNC event. Refer to Section 10.5.3 for more details about FECAP usage.
    pub mod FECAP {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
