...
pub mod CR {
    ...
    /// lock the configuration of GTZC1_TZSC_SECCFGRx and GTZC1_TZSC_PRIVCFGRx until next reset This bit is cleared by default and once set, it can not be reset until system reset.
    pub mod LCK {
        /// Offset (0 bits)
...
pub mod SECCFGR3 {
    ...
    /// secure access mode for register of ETH
    pub mod ETHSEC {
        /// Offset (11 bits)
        pub const offset: u32 = 11;
        /// Mask (1 bit: 1 << 11)
...
pub mod PRIVCFGR3 {
    ...
    /// privileged access mode for register of ETH
    pub mod ETHPRIV {
        /// Offset (11 bits)
        pub const offset: u32 = 11;
        /// Mask (1 bit: 1 << 11)
...
pub mod MPCWM1BCFGR {
    pub use super::MPCWM1ACFGR::PRIV;
    pub use super::MPCWM1ACFGR::SEC;
    pub use super::MPCWM1ACFGR::SREN;
    pub use super::MPCWM1ACFGR::SRLOCK;
}
...
pub mod MPCWM2AR {
    pub use super::MPCWM1AR::SUBA_LENGTH;
    pub use super::MPCWM1AR::SUBA_START;
}
...
pub mod MPCWM2BR {
    pub use super::MPCWM1BR::SUBB_LENGTH;
    pub use super::MPCWM1BR::SUBB_START;
}
...
pub struct RegisterBlock {
    ...
    /// GTZC1 TZSC privilege configuration register 3
    pub PRIVCFGR3: RWRegister<u32>,

    _reserved3: [u8; 20],

    /// GTZC1 TZSC memory 1 sub-region A watermark configuration register
    pub MPCWM1ACFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 1 sub-region A watermark register
    pub MPCWM1AR: RWRegister<u32>,

    /// GTZC1 TZSC memory 1 sub-region B watermark configuration register
    pub MPCWM1BCFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 1 sub-region B watermark register
    pub MPCWM1BR: RWRegister<u32>,

    /// GTZC1 TZSC memory 2 sub-region A watermark configuration register
    pub MPCWM2ACFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 2 sub-region A watermark register
    pub MPCWM2AR: RWRegister<u32>,

    /// GTZC1 TZSC memory 2 sub-region B watermark configuration register
    pub MPCWM2BCFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 2 sub-region B watermark register
    pub MPCWM2BR: RWRegister<u32>,

    /// GTZC1 TZSC memory 3 sub-region A watermark configuration register
    pub MPCWM3ACFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 3 sub-region A watermark register
    pub MPCWM3AR: RWRegister<u32>,

    /// GTZC1 TZSC memory 3 sub-region B watermark configuration register
    pub MPCWM3BCFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 3 sub-region B watermark register
    pub MPCWM3BR: RWRegister<u32>,

    /// GTZC1 TZSC memory 4 sub-region A watermark configuration register
    pub MPCWM4ACFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 4 sub-region A watermark register
    pub MPCWM4AR: RWRegister<u32>,

    /// GTZC1 TZSC memory 4 sub-region B watermark configuration register
    pub MPCWM4BCFGR: RWRegister<u32>,

    /// GTZC1 TZSC memory 4 sub-region B watermark register
    pub MPCWM4BR: RWRegister<u32>,
}
...
/// Access functions for the GTZC1_TZSC peripheral instance
pub mod GTZC1_TZSC {
    ...
    /// Reset values for each field in GTZC1_TZSC
    pub const reset: ResetValues = ResetValues {
        ...
        PRIVCFGR3: 0x00000000,
        MPCWM1ACFGR: 0x00000000,
        MPCWM1AR: 0x00000000,
        MPCWM1BCFGR: 0x00000000,
        MPCWM1BR: 0x00000000,
        MPCWM2ACFGR: 0x00000000,
        MPCWM2AR: 0x00000000,
        MPCWM2BCFGR: 0x00000000,
        MPCWM2BR: 0x00000000,
        MPCWM3ACFGR: 0x00000000,
        MPCWM3AR: 0x00000000,
        MPCWM3BCFGR: 0x00000000,
        MPCWM3BR: 0x00000000,
        MPCWM4ACFGR: 0x00000000,
        MPCWM4AR: 0x00000000,
        MPCWM4BCFGR: 0x00000000,
        MPCWM4BR: 0x00000000,
    };
    ...
    #[no_mangle]
    static mut GTZC1_TZSC_TAKEN: bool = false;

    /// Safe access to GTZC1_TZSC
    ///
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if GTZC1_TZSC_TAKEN {
                ...
                GTZC1_TZSC_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to GTZC1_TZSC
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if GTZC1_TZSC_TAKEN && inst.addr == INSTANCE.addr {
                GTZC1_TZSC_TAKEN = false;
            } else {
...
pub const GTZC1_TZSC: *const RegisterBlock = 0x40032400 as *const _;

/// Access functions for the SEC_GTZC1_TZSC peripheral instance
pub mod SEC_GTZC1_TZSC {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_GTZC1_TZSC
    pub const reset: ResetValues = ResetValues {
        CR: 0x00000000,
        SECCFGR1: 0x00000000,
        SECCFGR2: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_GTZC1_TZSC_TAKEN: bool = false;

    /// Safe access to SEC_GTZC1_TZSC
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_GTZC1_TZSC_TAKEN {
                None
            } else {
                SEC_GTZC1_TZSC_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_GTZC1_TZSC
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_GTZC1_TZSC_TAKEN && inst.addr == INSTANCE.addr {
                SEC_GTZC1_TZSC_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_GTZC1_TZSC: *const RegisterBlock = 0x50032400 as *const _;
