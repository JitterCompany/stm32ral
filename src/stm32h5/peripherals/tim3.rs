...
pub mod TIM3_SMCR {
    ...
    /// Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
    pub mod TS1 {
        /// Offset (4 bits)
        pub const offset: u32 = 4;
        /// Mask (3 bits: 0b111 << 4)
...
/// TIM3_CCMR1_Input and TIM3_CCMR1_Output
/// TIM3_CCMR1_Input: TIM3 capture/compare mode register 1 \\[alternate\\]
/// TIM3_CCMR1_Output: TIM3 capture/compare mode register 1 \\[alternate\\]
pub mod TIM3_CCMR1 {
...
/// TIM3_CCMR2_Input and TIM3_CCMR2_Output
/// TIM3_CCMR2_Input: TIM3 capture/compare mode register 2 \\[alternate\\]
/// TIM3_CCMR2_Output: TIM3 capture/compare mode register 2 \\[alternate\\]
pub mod TIM3_CCMR2 {
...
pub struct RegisterBlock {
    /// TIM3 control register 1
    pub TIM3_CR1: RWRegister<u16>,

    _reserved1: [u8; 2],

    /// TIM3 control register 2
    pub TIM3_CR2: RWRegister<u32>,

    /// TIM3 slave mode control register
    pub TIM3_SMCR: RWRegister<u32>,

    /// TIM3 DMA/Interrupt enable register
    pub TIM3_DIER: RWRegister<u32>,

    /// TIM3 status register
    pub TIM3_SR: RWRegister<u32>,

    /// TIM3 event generation register
    pub TIM3_EGR: WORegister<u16>,
    ...
    /// TIM3_CCMR1_Input: TIM3 capture/compare mode register 1 \\[alternate\\]
    /// TIM3_CCMR1_Output: TIM3 capture/compare mode register 1 \\[alternate\\]
    pub TIM3_CCMR1: RWRegister<u32>,

    /// TIM3_CCMR2_Input and TIM3_CCMR2_Output
    /// TIM3_CCMR2_Input: TIM3 capture/compare mode register 2 \\[alternate\\]
    /// TIM3_CCMR2_Output: TIM3 capture/compare mode register 2 \\[alternate\\]
    pub TIM3_CCMR2: RWRegister<u32>,

    /// TIM3 capture/compare enable register
    pub TIM3_CCER: RWRegister<u16>,

    _reserved3: [u8; 2],

    /// TIM3 counter
    pub TIM3_CNT: RWRegister<u32>,

    /// TIM3 prescaler
    pub TIM3_PSC: RWRegister<u16>,

    _reserved4: [u8; 2],

    /// TIM3 auto-reload register
    pub TIM3_ARR: RWRegister<u32>,

    _reserved5: [u8; 4],

    /// TIM3 capture/compare register 1
    pub TIM3_CCR1: RWRegister<u32>,

    /// TIM3 capture/compare register 2
    pub TIM3_CCR2: RWRegister<u32>,

    /// TIM3 capture/compare register 3
    pub TIM3_CCR3: RWRegister<u32>,

    /// TIM3 capture/compare register 4
    pub TIM3_CCR4: RWRegister<u32>,

    _reserved6: [u8; 20],

    /// TIM3 timer encoder control register
    pub TIM3_ECR: RWRegister<u32>,

    /// TIM3 timer input selection register
    pub TIM3_TISEL: RWRegister<u32>,

    /// TIM3 alternate function register 1
    pub TIM3_AF1: RWRegister<u32>,

    /// TIM3 alternate function register 2
    pub TIM3_AF2: RWRegister<u32>,

    _reserved7: [u8; 884],

    /// TIM3 DMA control register
    pub TIM3_DCR: RWRegister<u32>,

    /// TIM3 DMA address for full transfer
    pub TIM3_DMAR: RWRegister<u32>,
}
