...
pub use crate::stm32f1::peripherals::otg_fs_global::Instance;
pub use crate::stm32f1::peripherals::otg_fs_global::{RegisterBlock, ResetValues};
pub use crate::stm32f1::peripherals::otg_fs_global::{
