...
pub use crate::stm32f3::peripherals::dbgmcu::Instance;
pub use crate::stm32f3::peripherals::dbgmcu::{RegisterBlock, ResetValues};
pub use crate::stm32f3::peripherals::dbgmcu::{APB1_FZ, APB2FZ, CR, IDCODE};
