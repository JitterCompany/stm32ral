...
pub use crate::stm32f7::peripherals::otg_fs_global_v2::{
    CID, DIEPTXF0, DIEPTXF1, DIEPTXF2, DIEPTXF3, DIEPTXF4, DIEPTXF5, GADPCTL, GAHBCFG, GCCFG,
    GI2CCTL, GINTMSK, GINTSTS, GLPMCFG, GOTGCTL, GOTGINT, GPWRDN, GRSTCTL, GRXFSIZ, GRXSTSP,
    GRXSTSR, GUSBCFG, HNPTXSTS, HPTXFSIZ,
};
