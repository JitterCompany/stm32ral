...
pub use crate::stm32h5::peripherals::rtc::Instance;
pub use crate::stm32h5::peripherals::rtc::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::rtc::{
    ALRABINR, ALRBBINR, ALRMAR, ALRMASSR, ALRMBR, ALRMBSSR, CALR, CR, DR, ICSR, MISR, OR, PRER,
    PRIVCFGR, SCR, SECCFGR, SHIFTR, SMISR, SR, SSR, TR, TSDR, TSSSR, TSTR, WPR, WUTR,
};
...
pub const RTC: *const RegisterBlock = 0x44007800 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_RTC: *const RegisterBlock = 0x54007800 as *const _;
