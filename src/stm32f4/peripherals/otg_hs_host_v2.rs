...
pub struct RegisterBlock {
    ...
    /// OTG_HS host channel-0 characteristics register
    pub CHAR12: RWRegister<u32>,

    /// OTG_HS host channel-0 split control register
    pub SPLT12: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt register
    pub INT12: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt mask register
    pub INTMSK12: RWRegister<u32>,

    /// OTG_HS host channel-11 transfer size register
    pub TSIZ12: RWRegister<u32>,

    /// OTG_HS host channel-0 DMA address register
    pub DMA12: RWRegister<u32>,

    _reserved16: [u8; 8],

    /// OTG_HS host channel-0 characteristics register
    pub CHAR13: RWRegister<u32>,

    /// OTG_HS host channel-0 split control register
    pub SPLT13: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt register
    pub INT13: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt mask register
    pub INTMSK13: RWRegister<u32>,

    /// OTG_HS host channel-11 transfer size register
    pub TSIZ13: RWRegister<u32>,

    /// OTG_HS host channel-0 DMA address register
    pub DMA13: RWRegister<u32>,

    _reserved17: [u8; 8],

    /// OTG_HS host channel-0 characteristics register
    pub CHAR14: RWRegister<u32>,

    /// OTG_HS host channel-0 split control register
    pub SPLT14: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt register
    pub INT14: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt mask register
    pub INTMSK14: RWRegister<u32>,

    /// OTG_HS host channel-11 transfer size register
    pub TSIZ14: RWRegister<u32>,

    /// OTG_HS host channel-0 DMA address register
    pub DMA14: RWRegister<u32>,

    _reserved18: [u8; 8],

    /// OTG_HS host channel-0 characteristics register
    pub CHAR15: RWRegister<u32>,

    /// OTG_HS host channel-0 split control register
    pub SPLT15: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt register
    pub INT15: RWRegister<u32>,

    /// OTG_HS host channel-11 interrupt mask register
    pub INTMSK15: RWRegister<u32>,

    /// OTG_HS host channel-11 transfer size register
    pub TSIZ15: RWRegister<u32>,

    /// OTG_HS host channel-0 DMA address register
    pub DMA15: RWRegister<u32>,
}
