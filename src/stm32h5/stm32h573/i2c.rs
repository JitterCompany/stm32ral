...
pub use crate::stm32h5::peripherals::i2c::Instance;
pub use crate::stm32h5::peripherals::i2c::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::i2c::{
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const I2C3: *const RegisterBlock = 0x44002800 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const I2C4: *const RegisterBlock = 0x44002c00 as *const _;

/// Access functions for the SEC_I2C1 peripheral instance
pub mod SEC_I2C1 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_I2C1
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        OAR1: 0x00000000,
    ...
    /// Release exclusive access to SEC_I2C1
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
...
/// Access functions for the SEC_I2C2 peripheral instance
pub mod SEC_I2C2 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_I2C2
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        OAR1: 0x00000000,
    ...
    /// Release exclusive access to SEC_I2C2
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
...
/// Access functions for the SEC_I2C3 peripheral instance
pub mod SEC_I2C3 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_I2C3
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        OAR1: 0x00000000,
    ...
    /// Release exclusive access to SEC_I2C3
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_I2C3: *const RegisterBlock = 0x54002800 as *const _;

/// Access functions for the SEC_I2C4 peripheral instance
pub mod SEC_I2C4 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_I2C4
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        OAR1: 0x00000000,
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_I2C4: *const RegisterBlock = 0x54002c00 as *const _;
