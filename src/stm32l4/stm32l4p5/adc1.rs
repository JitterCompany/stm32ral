...
pub mod CR {
    ...
    pub mod DEEPPWD {
        ...
        pub mod RW {
            ...
            pub const NotDeepPowerDown: u32 = 0b0;

            /// 0b1: ADC in Deep-power-down (default reset state)
            pub const DeepPowerDown: u32 = 0b1;
        }
    }
...
pub mod CFGR {
    ...
    pub mod DFSDMCFG {
        ...
        pub mod RW {
            ...
            /// 0b0: DFSDM mode disabled
            pub const Disabled: u32 = 0b0;

            /// 0b1: DFSDM mode enabled
            pub const Enabled: u32 = 0b1;
        }
    }
...
pub mod CFGR2 {
    ...
    pub mod ROVSM {
        ...
        pub mod RW {
            ...
            /// 0b0: When injected conversions are triggered, the oversampling is temporary stopped and continued after the injection sequence (oversampling buffer is maintained during injected sequence)
            pub const ContinuedMode: u32 = 0b0;

            /// 0b1: When injected conversions are triggered, the current oversampling is aborted and resumed from start after the injection sequence (oversampling buffer is zeroed by injected sequence start)
            pub const ResumedMode: u32 = 0b1;
        }
    }
    ...
    pub mod TROVS {
        ...
        pub mod RW {
            ...
            /// 0b0: All oversampled conversions for a channel are done consecutively following a trigger
            pub const All: u32 = 0b0;
    ...
    pub mod OVSS {
        ...
        pub mod RW {
            ...
            /// 0b0001: Shift 1-bit
            pub const Shift1Bit: u32 = 0b0001;

            /// 0b0010: Shift 2-bit
            pub const Shift2Bit: u32 = 0b0010;

            /// 0b0011: Shift 3-bit
            pub const Shift3Bit: u32 = 0b0011;

            /// 0b0100: Shift 4-bit
            pub const Shift4Bit: u32 = 0b0100;

            /// 0b0101: Shift 5-bit
            pub const Shift5Bit: u32 = 0b0101;

            /// 0b0110: Shift 6-bit
            pub const Shift6Bit: u32 = 0b0110;

            /// 0b0111: Shift 7-bit
            pub const Shift7Bit: u32 = 0b0111;

            /// 0b1000: Shift 8-bit
            pub const Shift8Bit: u32 = 0b1000;
        }
    }
    ...
    pub mod OVSR {
        ...
        pub mod RW {
            ...
            /// 0b000: 2x
            pub const Ratio2: u32 = 0b000;

            /// 0b001: 4x
            pub const Ratio4: u32 = 0b001;

            /// 0b010: 8x
            pub const Ratio8: u32 = 0b010;

            /// 0b011: 16x
            pub const Ratio16: u32 = 0b011;

            /// 0b100: 32x
            pub const Ratio32: u32 = 0b100;

            /// 0b101: 64x
            pub const Ratio64: u32 = 0b101;

            /// 0b110: 128x
            pub const Ratio128: u32 = 0b110;

            /// 0b111: 256x
            pub const Ratio256: u32 = 0b111;
        }
    }
...
pub mod SMPR1 {
    ...
    pub mod SMPPLUS {
        ...
        pub mod RW {
            ...
            /// 0b0: The sampling time remains set to 2.5 ADC clock cycles remains
            pub const KeepCycles: u32 = 0b0;

            /// 0b1: 2.5 ADC clock cycle sampling time becomes 3.5 ADC clock cycles for the ADC_SMPR1 and ADC_SMPR2 registers
            pub const Add1Cycle: u32 = 0b1;
        }
    }
...
pub mod OFR1 {
    ...
    pub mod OFFSET1_EN {
        ...
        pub mod RW {
            ...
            /// 0b0: This bit is written by software to enable or disable the offset programmed into bits OFFSETy\[11:0\]
            pub const Disabled: u32 = 0b0;

            /// 0b1: This bit is written by software to enable or disable the offset programmed into bits OFFSETy\[11:0\]
            pub const Enabled: u32 = 0b1;
        }
    }
