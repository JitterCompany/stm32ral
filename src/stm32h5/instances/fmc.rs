...
pub use crate::stm32h5::peripherals::fmc::Instance;
pub use crate::stm32h5::peripherals::fmc::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::fmc::{
    BCR1, BCR2, BCR3, BCR4, BTR1, BTR2, BTR3, BTR4, BWTR1, BWTR2, BWTR3, BWTR4, ECCR, PATT, PCR,
    PCSCNTR, PMEM, SDCMR, SDCR1, SDCR2, SDRTR, SDSR, SDTR1, SDTR2, SR,
};
...
pub const FMC: *const RegisterBlock = 0x47000400 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_FMC: *const RegisterBlock = 0x57000400 as *const _;
