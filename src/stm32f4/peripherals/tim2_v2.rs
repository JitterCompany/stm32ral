...
//!
//! Used by: stm32f407, stm32f427, stm32f429
...
pub mod OR {
    ...
    pub mod ITR1_RMP {
        ...
        pub mod RW {
            ...
            /// 0b00: TIM8 trigger output is connected to TIM2_ITR1 input
            pub const TIM8_TRGOUT: u32 = 0b00;

            /// 0b01: Ethernet PTP clock is connected to TIM2_ITR1 input
            pub const PTP: u32 = 0b01;

            /// 0b10: OTG FS SOF is connected to the TIM2_ITR1 input
            pub const OTG_FS_SOF: u32 = 0b10;

            /// 0b11: OTG HS SOF is connected to the TIM2_ITR1 input
            pub const OTG_HS_SOF: u32 = 0b11;
        }
    }
}
#[repr(C)]
