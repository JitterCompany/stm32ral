...
/// TIM16_CCMR1_Input and TIM16_CCMR1_Output
/// TIM16_CCMR1_Input: TIM16 capture/compare mode register 1 \\[alternate\\]
/// TIM16_CCMR1_Output: TIM16 capture/compare mode register 1 \\[alternate\\]
pub mod TIM16_CCMR1 {
...
pub struct RegisterBlock {
    /// TIM16 control register 1
    pub TIM16_CR1: RWRegister<u16>,

    _reserved1: [u8; 2],

    /// TIM16 control register 2
    pub TIM16_CR2: RWRegister<u16>,

    _reserved2: [u8; 6],

    /// TIM16 DMA/interrupt enable register
    pub TIM16_DIER: RWRegister<u16>,

    _reserved3: [u8; 2],

    /// TIM16 status register
    pub TIM16_SR: RWRegister<u16>,

    _reserved4: [u8; 2],

    /// TIM16 event generation register
    pub TIM16_EGR: WORegister<u16>,
    ...
    /// TIM16_CCMR1_Input: TIM16 capture/compare mode register 1 \\[alternate\\]
    /// TIM16_CCMR1_Output: TIM16 capture/compare mode register 1 \\[alternate\\]
    pub TIM16_CCMR1: RWRegister<u32>,

    _reserved6: [u8; 4],

    /// TIM16 capture/compare enable register
    pub TIM16_CCER: RWRegister<u16>,

    _reserved7: [u8; 2],

    /// TIM16 counter
    pub TIM16_CNT: RWRegister<u32>,

    /// TIM16 prescaler
    pub TIM16_PSC: RWRegister<u16>,

    _reserved8: [u8; 2],

    /// TIM16 auto-reload register
    pub TIM16_ARR: RWRegister<u32>,

    /// TIM16 repetition counter register
    pub TIM16_RCR: RWRegister<u16>,

    _reserved9: [u8; 2],

    /// TIM16 capture/compare register 1
    pub TIM16_CCR1: RWRegister<u32>,

    _reserved10: [u8; 12],

    /// TIM16 break and dead-time register
    pub TIM16_BDTR: RWRegister<u32>,

    _reserved11: [u8; 12],

    /// TIM16 timer deadtime register 2
    pub TIM16_DTR2: RWRegister<u32>,

    _reserved12: [u8; 4],

    /// TIM16 input selection register
    pub TIM16_TISEL: RWRegister<u32>,

    /// TIM16 alternate function register 1
    pub TIM16_AF1: RWRegister<u32>,

    /// TIM16 alternate function register 2
    pub TIM16_AF2: RWRegister<u32>,

    _reserved13: [u8; 884],

    /// TIM16 DMA control register
    pub TIM16_DCR: RWRegister<u32>,

    /// TIM16/TIM17 DMA address for full transfer
    pub TIM16_DMAR: RWRegister<u32>,
}
