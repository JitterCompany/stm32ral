...
pub use crate::stm32h5::peripherals::usart::Instance;
pub use crate::stm32h5::peripherals::usart::{RegisterBlock, ResetValues};
pub use crate::stm32h5::peripherals::usart::{
    BRR, CR1, CR2, CR3, GTPR, ICR, ISR, PRESC, RDR, RQR, RTOR, TDR,
};

/// Access functions for the SEC_UART12 peripheral instance
pub mod SEC_UART12 {
    ...
    /// Reset values for each field in SEC_UART12
    ...
    #[no_mangle]
    static mut SEC_UART12_TAKEN: bool = false;

    /// Safe access to SEC_UART12
    ///
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART12_TAKEN {
                ...
                SEC_UART12_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_UART12
    ///
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART12_TAKEN && inst.addr == INSTANCE.addr {
                SEC_UART12_TAKEN = false;
            } else {
...
pub const SEC_UART12: *const RegisterBlock = 0x50008400 as *const _;
...
/// Access functions for the SEC_UART7 peripheral instance
pub mod SEC_UART7 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_UART7
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_UART7_TAKEN: bool = false;

    /// Safe access to SEC_UART7
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART7_TAKEN {
                ...
                SEC_UART7_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_UART7
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART7_TAKEN && inst.addr == INSTANCE.addr {
                SEC_UART7_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_UART7: *const RegisterBlock = 0x50007800 as *const _;

/// Access functions for the SEC_UART8 peripheral instance
pub mod SEC_UART8 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_UART8
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_UART8_TAKEN: bool = false;

    /// Safe access to SEC_UART8
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART8_TAKEN {
                ...
                SEC_UART8_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_UART8
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART8_TAKEN && inst.addr == INSTANCE.addr {
                SEC_UART8_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_UART8: *const RegisterBlock = 0x50007c00 as *const _;

/// Access functions for the SEC_UART9 peripheral instance
pub mod SEC_UART9 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_UART9
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_UART9_TAKEN: bool = false;

    /// Safe access to SEC_UART9
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART9_TAKEN {
                ...
                SEC_UART9_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_UART9
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_UART9_TAKEN && inst.addr == INSTANCE.addr {
                SEC_UART9_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_UART9: *const RegisterBlock = 0x50008000 as *const _;
...
/// Access functions for the SEC_USART10 peripheral instance
pub mod SEC_USART10 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_USART10
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_USART10_TAKEN: bool = false;

    /// Safe access to SEC_USART10
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_USART10_TAKEN {
                None
            } else {
                SEC_USART10_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_USART10
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_USART10_TAKEN && inst.addr == INSTANCE.addr {
                SEC_USART10_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_USART10: *const RegisterBlock = 0x50006800 as *const _;

/// Access functions for the SEC_USART11 peripheral instance
pub mod SEC_USART11 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_USART11
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_USART11_TAKEN: bool = false;

    /// Safe access to SEC_USART11
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_USART11_TAKEN {
                None
            } else {
                SEC_USART11_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_USART11
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_USART11_TAKEN && inst.addr == INSTANCE.addr {
                SEC_USART11_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_USART11: *const RegisterBlock = 0x50006c00 as *const _;
...
/// Access functions for the SEC_USART6 peripheral instance
pub mod SEC_USART6 {
    use super::ResetValues;
    ...
    /// Reset values for each field in SEC_USART6
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut SEC_USART6_TAKEN: bool = false;

    /// Safe access to SEC_USART6
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    pub fn take() -> Option<Instance> {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_USART6_TAKEN {
                ...
                SEC_USART6_TAKEN = true;
                Some(INSTANCE)
            }
        })
    }

    /// Release exclusive access to SEC_USART6
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if SEC_USART6_TAKEN && inst.addr == INSTANCE.addr {
                SEC_USART6_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
        });
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const SEC_USART6: *const RegisterBlock = 0x50006400 as *const _;

/// Access functions for the UART12 peripheral instance
pub mod UART12 {
    use super::ResetValues;
    ...
    /// Reset values for each field in UART12
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut UART12_TAKEN: bool = false;

    /// Safe access to UART12
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to UART12
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if UART12_TAKEN && inst.addr == INSTANCE.addr {
                UART12_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const UART12: *const RegisterBlock = 0x40008400 as *const _;
...
pub mod UART9 {
    ...
    /// Reset values for each field in UART9
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut UART9_TAKEN: bool = false;

    /// Safe access to UART9
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to UART9
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if UART9_TAKEN && inst.addr == INSTANCE.addr {
                UART9_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const UART9: *const RegisterBlock = 0x40008000 as *const _;
...
/// Access functions for the USART10 peripheral instance
pub mod USART10 {
    use super::ResetValues;
    ...
    /// Reset values for each field in USART10
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut USART10_TAKEN: bool = false;

    /// Safe access to USART10
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to USART10
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if USART10_TAKEN && inst.addr == INSTANCE.addr {
                USART10_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const USART10: *const RegisterBlock = 0x40006800 as *const _;

/// Access functions for the USART11 peripheral instance
pub mod USART11 {
    use super::ResetValues;
    ...
    /// Reset values for each field in USART11
    pub const reset: ResetValues = ResetValues {
        CR1: 0x00000000,
        CR2: 0x00000000,
        CR3: 0x00000000,
    ...
    #[allow(private_no_mangle_statics)]
    #[no_mangle]
    static mut USART11_TAKEN: bool = false;

    /// Safe access to USART11
    ///
    /// This function returns `Some(Instance)` if this instance is not
    /// currently taken, and `None` if it is. This ensures that if you
    /// do get `Some(Instance)`, you are ensured unique access to
    ...
    /// Release exclusive access to USART11
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    pub fn release(inst: Instance) {
        external_cortex_m::interrupt::free(|_| unsafe {
            if USART11_TAKEN && inst.addr == INSTANCE.addr {
                USART11_TAKEN = false;
            } else {
                panic!("Released a peripheral which was not taken");
            }
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const USART11: *const RegisterBlock = 0x40006c00 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const USART6: *const RegisterBlock = 0x40006400 as *const _;
